    ...
    <View style={styles.container}>
      {records.map((record, index) => (
        <View key={index} style={styles.card}>
          ...
          <Text style={styles.bodyText}>
            Uric Acid: {record.uricAcid} mg/dL
          </Text>
          <Text style={styles.bodyText}>
            Vitamin D: {record.vitaminD} ng/mL
          </Text>
          <Text style={styles.bodyText}>
            Magnesium: {record.magnesium} mg/dL
          </Text>
          <Text style={styles.bodyText}>
            Vitamin B12: {record.vitaminB12} pg/mL
          </Text>
          <Text style={styles.bodyText}>
            Fasting Blood Glucose: {record.fastingBloodGlucose} mg/dL
          </Text>
          <Text style={styles.bodyText}>
            Lipid Profile: {record.lipidProfile} mg/dL
          </Text>
