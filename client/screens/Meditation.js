    ...
    <View style={styles.container}>
      <View style={styles.cardsContainer}>
        <ScrollView>
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(
                require("../assets/medi1.mp3"),
                "Guided Session 1 - Singing Bowl"
              )
            }
            style={styles.card}
          >
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(
                require("../assets/medi2.mp3"),
                "Guided Session 1 - Tranquil"
              )
            }
            style={styles.card}
          >
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(
                require("../assets/medi3.mp3"),
                "Guided Session 1 - Serene"
              )
            }
            style={styles.card}
          >
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(require("../assets/medi4.mp3"), "Soothing")
            }
            style={styles.card}
          >
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(require("../assets/medi5.mp3"), "Mysterious")
            }
            style={styles.card}
          >
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(require("../assets/medi6.mp3"), "Calm")
            }
            style={styles.card}
          >
            <View style={styles.cardContent}>
          ...
          <TouchableOpacity
            onPress={() =>
              handleAudioSelect(require("../assets/medi7.mp3"), "Peaceful")
            }
            style={styles.card}
          >
            <View style={styles.cardContent}>
      ...
      {showCurrentlyPlaying && (
        <View style={styles.audioPlaying}>
          ...
          <Text style={styles.currentlyPlayingText}>
            Currently Playing: {audioName}
          </Text>
          <TouchableOpacity
            onPress={handleCloseCurrentlyPlaying}
