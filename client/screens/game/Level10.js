...
const Level10 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.Title2}>Difficulty: Impossible</Text>
      <Text style={styles.Title3}>Note: Every 10 seconds the fruits get reshuffled and all the matches gets reset.</Text>
