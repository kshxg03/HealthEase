...
const Level7 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.Title2}>Difficulty: Hard</Text>
      <Text style={styles.Title3}>Note: Every 25 seconds the fruits get reshuffled and all the matches gets reset.</Text>
